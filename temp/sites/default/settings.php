 ...
 *
 */
$drupal_hash_salt = 'cdf26213a150dc3ecb610f18f6b38b46';
...
/**
 * Allow mixed-mode HTTP and HTTPS sessions
 */
//$conf['https'] = TRUE;
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drops_local.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drops_local.inc');
//</DDSETTINGS>
